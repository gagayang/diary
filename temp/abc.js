...
var AmericanPeople = /** @class */ (function (_super) {
    ...
    AmericanPeople.prototype.eat = function () { console.log("用叉子吃饭..."); };
...
var ChinesePeople = /** @class */ (function (_super) {
    ...
    ChinesePeople.prototype.eat = function () { console.log("用筷子吃饭..."); };
...
var TuzhuPeople = /** @class */ (function (_super) {
    ...
    TuzhuPeople.prototype.eat = function () { console.log("用手抓吃饭..."); };
    return TuzhuPeople;
}(People));
